...
>
  <head>
    ...
    <title>@yield('title', 'Sijala')</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ url('public/admin') }}/assets/img/favicon/mega.png" />
    ...
    <link rel="stylesheet" href="{{ url('public') }}/calendar/calendar">
    <script src="{{ url('public') }}/calendar/calendar.js"></script>

    {{-- vanilla calendar --}}
    <!-- Plugin CSS -->
    <link href="{{ url('public') }}/calendar/vanilla-calendar.min.css" rel="stylesheet">
    <link href="{{ url('public') }}/calendar/themes/light.min.css" rel="stylesheet">
    <link href="{{ url('public') }}/calendar/themes/dark.min.css" rel="stylesheet">
    <!-- Plugin JS -->
    <script src="{{ url('public') }}/calendar/vanilla-calendar.min.js" defer></script>
  ...
  <body>
    ...
    <!-- Tambahkan pustaka plugin kalender dari CDNJS -->
